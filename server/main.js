...
if(!game.treatment.hierarchicalSpeakingTime){
    ...
    _.times(game.treatment.nRounds, i => {
        ...
        _.times(game.treatment.nBlocks, j => {
            ...
            if(countOfBlock===0) {
                ...
                countOfBlock = countOfBlock + 1;
            }else if(countOfBlock==1){

                swappedPlayer = shuffledPlayers[2];
                //player 0 gets 2 turns, player 1 gets 1 turn
                shuffledPlayers.splice(2, 1, shuffledPlayers[0]);
                shuffledPlayers.forEach(player => {
                    round.addStage({
                        name: player.get("name") + j,
                        displayName:
                ...
                //replace old player
                shuffledPlayers.splice(2, 1, swappedPlayer);
                //player 0 gets 2 turns, player 2 gets 1 turn
                shuffledPlayers.splice(1, 1, shuffledPlayers[0]);
